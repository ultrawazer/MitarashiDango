...
- **Docker & Unraid Ecosystem**: Official Unraid templates, `su-exec` PUID/PGID user mapping, GPU passthrough (`/dev/dri`), and companion FlareSolverr stack via [`Dando_Docker`](https://github.com/ultrawazer/MitarashiDango_Docker).
