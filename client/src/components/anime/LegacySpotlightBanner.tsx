...
import styles from './LegacySpotlightBanner.module.css'

interface LegacySpotlightBannerProps {
  animeList: Anime[]
}

const LegacySpotlightBanner: React.FC<LegacySpotlightBannerProps> = ({ animeList }) => {
...
export default LegacySpotlightBanner
