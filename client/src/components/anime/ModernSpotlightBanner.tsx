...
interface ModernSpotlightBannerProps {
  animeList: Anime[]
  blur?: number
}
...
const ModernSpotlightBanner: React.FC<ModernSpotlightBannerProps> = ({ animeList, blur = 28 }) => {
  ...
  return (
    <div
      ...
      style={{ '--spotlight-blur': `${blur}px` } as React.CSSProperties}
...
export default ModernSpotlightBanner
